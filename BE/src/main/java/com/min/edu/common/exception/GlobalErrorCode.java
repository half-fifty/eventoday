...
public enum GlobalErrorCode {
    ...
    BOOTH_NOT_AVAILABLE(HttpStatus.CONFLICT, "BOOTH_409_002", "해당 부스는 신청 가능한 상태가 아닙니다."),
    BOOTH_APPLICATION_CONFLICT(HttpStatus.CONFLICT, "BOOTH_409_003", "다른 신청에 의해 이미 처리되었습니다. 잠시 후 다시 시도해주세요."),
    APPLICATION_NUMBER_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "BOOTH_500_001", "신청번호 생성에 실패했습니다.");
