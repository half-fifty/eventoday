...
public enum GlobalErrorCode implements ErrorCode {
    ...
    EXCHANGE_CODE_REQUEST_RECIPIENT_EMAIL_INVALID(HttpStatus.CONFLICT, "ADMISSION_409_020", "교환 코드 발급 메일 수신자 이메일 형식이 올바르지 않습니다."),
    ...
    IDEMPOTENCY_KEY_CONFLICT(HttpStatus.CONFLICT, "TICKET_409_002", "Idempotency-Key가 다른 티켓 주문 요청에서 사용되었습니다."),
    IDEMPOTENCY_REQUEST_IN_PROGRESS(HttpStatus.CONFLICT, "TICKET_409_003", "같은 Idempotency-Key의 티켓 주문이 현재 처리 중입니다."),
    TICKET_ORDER_BUSY(HttpStatus.TOO_MANY_REQUESTS, "TICKET_429_001", "티켓 주문 요청이 일시적으로 많습니다. 잠시 후 다시 시도해 주세요."),
    ...
    RECRUITMENT_REQUIRES_AT_LEAST_ONE_BOOTH(HttpStatus.BAD_REQUEST, "RECRUITMENT_400_004", "부스를 최소 1개 이상 등록해야 모집 공고를 등록할 수 있습니다."),
    ...
    BOOTH_REVIEW_TICKET_REQUIRED(HttpStatus.FORBIDDEN, "BOOTH_403_001", "행사 티켓을 구매한 관람객만 후기를 작성할 수 있습니다."),
    BOOTH_REVIEW_EVENT_NOT_ONGOING(HttpStatus.UNPROCESSABLE_ENTITY, "BOOTH_422_008", "진행 중이거나 종료 후 7일 이내인 행사의 부스만 후기를 작성할 수 있습니다."),
    BOOTH_REVIEW_SELF_REPORT_NOT_ALLOWED(HttpStatus.FORBIDDEN, "BOOTH_403_003", "본인이 작성한 리뷰는 신고할 수 없습니다."),
    BOOTH_RESERVATION_TICKET_REQUIRED(HttpStatus.FORBIDDEN, "BOOTH_403_002", "행사 티켓을 구매한 관람객만 부스를 예약할 수 있습니다."),
